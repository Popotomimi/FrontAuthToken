    ...
    <div className="bg-gray-100 min-h-screen text-center flex flex-col items-center p-6">
      ...
      {authenticated && user ? (
        ...
        <>
          <p className="text-lg text-gray-600 text-center max-w-xl my-4">
            ...
            sua conta, fazer login e logout. Explore o site e descubra o que ele
            pode oferecer!
          </p>
          <p className="text-lg text-gray-600 text-center max-w-xl my-4">
            Utilizamos o <span className="font-semibold">jsonwebtoken</span> e{" "}
            <span className="font-semibold">bcrypt</span> para garantir a
            segurança e confiabilidade da autenticação. O backend foi construído
            com uma
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <p className="text-gray-600">
            Frontend utilizando as melhores práticas com
